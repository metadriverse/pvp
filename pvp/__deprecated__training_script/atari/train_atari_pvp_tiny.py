...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp-name", default="Fixed_Discrete_old", type=str, help="The experiment name.")
    parser.add_argument("--wandb", action="store_true", help="Set to True to upload stats to wandb.")
    parser.add_argument("--seed", default=0, type=int, help="The random seed.")
    parser.add_argument(
        "--obs-mode", default="image", choices=["vector", "image"], help="Set to True to upload stats to wandb."
    )
    parser.add_argument("--env-name", default="PongNoFrameskip-v4", type=str, help="Name of Gym environment")
    ...
    env = AtariWrapper(env=env, screen_size=42)
