...
class ControlLoss(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        has to reach a target point (_distance_to_go). If this does not happen within
        ...
        # endcondition: Check if vehicle reached waypoint _distance_to_go from here:
        end_condition = DriveDistance(self.ego_vehicles[0], self._distance_to_go)
