...
from pvp.sb3.common.vec_env.base_vec_env import VecEnv, VecEnvObs, VecEnvStepReturn, VecEnvWrapper
...
class VecMonitor(VecEnvWrapper):
    ...
    def __init__(
        ...
        from pvp.sb3.common.monitor import Monitor, ResultsWriter
