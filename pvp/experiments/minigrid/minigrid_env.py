"""
TODO: Rewrite this file with latest minigrid.
"""
import cv2
import gym
...
from pvp.experiments.minigrid.rendering import Window
...
class MinigridWrapper(Wrapper):
    def __init__(self, env, enable_human=False, enable_render=False):
        ...
        # PZH: We can simply leave three useful action dimensions here.
