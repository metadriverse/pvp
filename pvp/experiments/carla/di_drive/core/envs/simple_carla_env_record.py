...
class SimpleCarlaEnv(BaseCarlaEnv):
    ...
    def get_observations(self) -> Dict:
        ...
        self.xxx_step += 1
        folder_name = "/home/xxx/nvme/iclr-visual/carla_pvp/"
        curr_name = "carlaframe_{}.png".format('{0:05}'.format(self.xxx_step))
        from PIL import Image
        import os
        saveimg = Image.fromarray(sensor_data['vis'])
        saveimg.save(os.path.join(folder_name, curr_name))
