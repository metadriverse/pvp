...
class VehicleTurningRight(BasicScenario):
    ...
    def __init__(
        ...
        super(VehicleTurningRight, self).__init__(
            "VehicleTurningRight", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable
        )
    ...
    def _create_behavior(self):
        ...
        if self._ego_route is not None:
            trigger_distance = InTriggerDistanceToLocationAlongRoute(
                self.ego_vehicles[0], self._ego_route, self._other_actor_transform.location, bycicle_start_dist
            )
        else:
        ...
        actor_ego_sync = py_trees.composites.Parallel(
            "Synchronization of actor and ego vehicle", policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE
        )
        ...
        scenario_sequence.add_child(
            ActorTransformSetter(self.other_actors[0], self._other_actor_transform, name='TransformSetterTS4')
        )
...
class VehicleTurningLeft(BasicScenario):
    ...
    def __init__(
        ...
        super(VehicleTurningLeft, self).__init__(
            "VehicleTurningLeft", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable
        )
...
class VehicleTurningRoute(BasicScenario):
    ...
    def __init__(
        ...
        super(VehicleTurningRoute, self).__init__(
            "VehicleTurningRoute", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable
        )
