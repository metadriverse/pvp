# visualize single ckpt (save image step by step) for metadrive TD3 baseline
import copy
import os
import time
...
def evaluate_metadrive_once(
    ...
    try:
        ...
        while True:
            ...
            action = policy_function(o, deterministic=True)[0]
...
if __name__ == '__main__':
    ret = evaluate_metadrive_once(
        ...
        ckpt_index=2000000,
        folder_name="/home/xxx/nvme/iclr-visual/metadrive/ck39000/td3new",
        use_render=True,
        num_ep_in_one_env=5,
        total_env_num=50,
        seed=39000,
